...
// Assets
const VOICEOVER_URL = "https://pub-e3bfc0083b0644b296a7080b21024c5f.r2.dev/audio/1770723001434_0nwrbfpgn6x_nPczCjzI_Building_your_busine.mp3";
const MUSIC_URL = "https://pub-e3bfc0083b0644b296a7080b21024c5f.r2.dev/music/1770723049406_0gjhm98hjts_music_Modern_uplifting_cor.mp3";
const SCREENSHOT_URL = "https://pub-e3bfc0083b0644b296a7080b21024c5f.r2.dev/superlinks/1770723090227_pz67odrzhos_superlinks_screenshot.png";
    ...
    <AbsoluteFill style={{ backgroundColor: COLORS.dark }}>
      ...
      <Zoom from={1.02} to={1}>
        <AbsoluteFill className="flex flex-col items-center justify-center gap-6">
          ...
          <div style={{ opacity: interpolate(frame, [20, 35], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
            <div 
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0f" }}>
      {icons.map((icon, i) => {
        ...
        const opacity = interpolate(frame, [0, 15], [0, 0.4], { extrapolateRight: "clamp" });
      ...
      <Zoom from={1} to={1.03}>
        <AbsoluteFill className="flex flex-col items-center justify-center">
          ...
          <div style={{ opacity: interpolate(frame, [25, 40], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
            <div 
      ...
      <Zoom from={1.02} to={1}>
        <AbsoluteFill className="flex flex-col items-center justify-center gap-8">
          {painPoints.map((point, i) => {
            const opacity = interpolate(frame, [point.delay, point.delay + 12], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
            const x = interpolate(frame, [point.delay, point.delay + 12], [-30, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.out(Easing.cubic) });
    ...
    <AbsoluteFill style={{ backgroundColor: COLORS.dark }}>
      ...
      <Zoom from={0.95} to={1}>
        <AbsoluteFill className="flex flex-col items-center justify-center gap-6">
          ...
          <div style={{ opacity: interpolate(frame, [15, 30], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
            <TextAnimation
              startFrom={15}
              createTimeline={({ textRef, tl, SplitText }) => {
                const split = new SplitText(textRef.current, { type: "chars" });
    ...
    <AbsoluteFill>
      ...
      <Zoom from={1} to={1.03}>
        <AbsoluteFill className="flex flex-col items-center justify-center gap-4">
          ...
          <LogoReveal revealStyle="glow" glowColor={COLORS.primary} duration={0.8} delay={0.3}>
            <div 
          ...
          <div style={{ opacity: interpolate(frame, [35, 50], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }}>
            <div 
...
const FeatureDemoScene: React.FC = () => {
  ...
  const rotateX = interpolate(frame, [0, 30], [15, 5], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const rotateY = interpolate(frame, [0, 30], [-10, -3], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
        ...
        <AbsoluteFill className="flex items-center justify-center">
          <div className="flex flex-col gap-10">
            {features.map((feature, i) => {
              ...
              const x = interpolate(frame, [delay, delay + 15], [50, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.out(Easing.back(1.5)) });
              const featureScale = interpolate(frame, [delay, delay + 15], [0.8, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
      ...
      <Zoom from={1} to={1.05}>
        <AbsoluteFill className="flex items-center justify-center">
          <OutlineStream
            ...
            color={COLORS.white}
            transitionDuration={12}
            style={{ fontFamily: displayFont, textAlign: "center", padding: "0 40px" }}
          />
        </AbsoluteFill>
      </Zoom>
...
const LogoCTAScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.darker }}>
      ...
      <Zoom from={1} to={1.02}>
        <AbsoluteFill className="flex flex-col items-center justify-center gap-8">
          <LogoReveal revealStyle="elastic" duration={1} glowColor={COLORS.primary}>
            <div 
              className="text-8xl font-black"
              style={{ 
                fontFamily: displayFont, 
